...
exchangerate_csv <- read.csv("https://raw.githubusercontent.com/faytseng/Start-R/master/ExchangeRate_l3mth.csv", header=TRUE , colClasses = c("Date", "character", "numeric"))
